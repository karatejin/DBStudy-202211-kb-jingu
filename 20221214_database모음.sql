...
INSERT INTO `order_mst` VALUES (1,'앗! 뜨거워! 핫해! 겨울 신발 특가 LIVE',39000,99),(2,'네퓨어 마스크의 특집 앵콜 라이브',41900,500),(3,'겨울엔 기린호빵',9900,100),(4,'셀렉스 하반기 결산 어워즈 셀렉스 코어프로팅 프로 스틱',11650,50),(5,'앗! 뜨거워! 핫해! 겨울 신발 특가 LIVE',39000,10),(6,'앗! 뜨거워! 핫해! 겨울 신발 특가 LIVE',39000,5),(7,'앗! 뜨거워! 핫해! 겨울 신발 특가 LIVE',39000,50),(8,'네퓨어 마스크의 특집 앵콜 라이브',41900,100),(9,'네퓨어 마스크의 특집 앵콜 라이브',41900,50),(10,'겨울엔 기린호빵',9900,50),(11,'셀렉스 하반기 결산 어워즈 셀렉스 코어프로팅 프로 스틱',11650,30),(12,'셀렉스 하반기 결산 어워즈 셀렉스 코어프로팅 프로 스틱',11650,10);
...
-- Dump completed on 2022-12-14 13:17:40
...
INSERT INTO `user_dtl` VALUES (1,'김준일','aaa@gmail.com','01099881916'),(2,'김준이','bbb@gmail.com','01012345678'),(3,NULL,NULL,NULL),(4,NULL,NULL,NULL),(5,NULL,NULL,NULL),(6,NULL,NULL,NULL),(7,NULL,NULL,NULL);
...
INSERT INTO `product_mst` VALUES (1,'스타벅스 블랙 텀블러',25000),(2,'스타벅스 화이트 텀블러',30000),(3,'스타벅스 블루 텀블러',20000),(4,'스타벅스 블랙 머그컵',15000),(5,'스타벅스 화이트 머그컵',20000),(6,'스타벅스 블루 머그컵',25000);
...
INSERT INTO `study_notice_mst` VALUES (1,'첫번째 공지사항','aaa\r\n',1),(2,'두번째 공지사항','bbb',1),(3,'세번째 공지사항','ccc',2);
...
LOCK TABLES `user_dtl` WRITE;
/*!40000 ALTER TABLE `user_dtl` DISABLE KEYS */;
INSERT INTO `user_dtl` VALUES (1,NULL,NULL,'2022-12-09 10:44:02','2022-12-09 10:44:02'),(3,NULL,NULL,'2022-12-09 10:44:02','2022-12-09 10:44:02'),(4,NULL,NULL,'2022-12-09 10:44:02','2022-12-09 10:44:02');
/*!40000 ALTER TABLE `user_dtl` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `user_mst` WRITE;
/*!40000 ALTER TABLE `user_mst` DISABLE KEYS */;
INSERT INTO `user_mst` VALUES (1,'aaa','1234','김준일','aaa@gmail.com','2022-12-09 10:44:02','2022-12-09 10:44:02'),(2,'bbb','1234','김준일','aaa@gmail.com','2022-12-09 10:44:02','2022-12-09 10:44:02'),(3,'ccc','1234','김준일','aaa@gmail.com','2022-12-09 10:44:02','2022-12-09 10:44:02'),(4,'ddd','1234','김준일','aaa@gmail.com','2022-12-09 10:44:02','2022-12-09 10:44:02');
/*!40000 ALTER TABLE `user_mst` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
...
-- Dump completed on 2022-12-14 13:17:41
